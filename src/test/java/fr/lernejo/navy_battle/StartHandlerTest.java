...
class StartHandlerTest {
    ...
    void StartHandler_true() {
        try {
            ...
            HttpRequest request = HttpRequest.newBuilder()
                .uri(URI.create("http://localhost:4530/api/game/start"))
                .header("Accept", "application/json")
                .POST(HttpRequest.BodyPublishers.ofString("{\"id\":\"1\", \"url\":\"http://localhost:4530\", \"message\":\"Start success\"}"))
                .build();
    ...
    void StartHandler_not_POST_false() {
        try {
            ...
            HttpClient client = HttpClient.newHttpClient();
            HttpRequest request = HttpRequest.newBuilder()
                .uri(URI.create("http://localhost:4540/api/game/start"))
                .header("Accept", "application/json")
                .PUT(HttpRequest.BodyPublishers.ofString("{\"id\":\"1\", \"url\":\"http://localhost:4540\", \"message\":\"Start success\"}"))
                .build();
            CompletableFuture<HttpResponse<String>> completableFuture = client.sendAsync(request, HttpResponse.BodyHandlers.ofString());
            completableFuture
                .thenApplyAsync(HttpResponse::headers);
    ...
    void StartHandler_parameter_missing_false() {
        try {
            ...
            HttpClient client = HttpClient.newHttpClient();
            HttpRequest request = HttpRequest.newBuilder()
                .uri(URI.create("http://localhost:4550/api/game/start"))
                .header("Accept", "application/json")
                .POST(HttpRequest.BodyPublishers.ofString("{\"id\":\"1\", \"url\":\"http://localhost:4550\"}"))
                .build();
            CompletableFuture<HttpResponse<String>> completableFuture = client.sendAsync(request, HttpResponse.BodyHandlers.ofString());
            completableFuture
                .thenApplyAsync(HttpResponse::headers);
